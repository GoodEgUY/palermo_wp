...
<div class="mainWrapper">
    <section>
        <div class="archiveProductWrapper wrapper">
            ...
            <div class="categoryHeaderItem"><a href="<?php echo esc_url( home_url( '/product/' ) ); ?>">Всі</a></div>
                ...
                if ($terms && !is_wp_error($terms)) :
                    ...
                    foreach ($terms as $term) :
                        ?>
                        <div class="categoryHeaderItem <?php echo (is_tax('product_category', $term->slug) ? 'activeCategory' : ''); ?>">
