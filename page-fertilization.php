...
<div class="mainWrapper">
    <section>
        <div class="introWrapper2 wrapper">
            ...
            <div class="introIcons2">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/screen2/recycleIcons.svg" alt="">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/screen2/savewaterIcons.svg" alt="">
                    ...
                    <div class="chartItem">
                        ...
                        <div class="chartItemColumn">
                            <svg width="88" height="320" viewBox="0 0 88 320" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <rect x="0" y="0" width="88" height="320" rx="20" ry="20" fill="#353535" />
                                <!-- Заполненная часть прямоугольника -->
                                <rect x="0" class="chart-fill " style="--final-height: 240px; --final-y: 80px;" y="270"
                        ...
                        <div class="chartItemColumn">
                            <svg width="88" height="320" viewBox="0 0 88 320" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <rect x="0" y="0" width="88" height="320" rx="20" ry="20" fill="#353535" />
                                <!-- Заполненная часть прямоугольника -->
                                <rect x="0" class="chart-fill " style="--final-height: 288px; --final-y: 32px;" y="270"
                                    width="88" height="50" rx="20" ry="20" fill="#23AAEB" />
                                <!-- Текст -->
                                <text x="43" y="296" font-size="16" font-family="Arial, sans-serif" fill="white"
                                    text-anchor="middle">
                    ...
                    <div class="chartItem">
                        ...
                        <div class="chartItemColumn">
                            <svg width="88" height="320" viewBox="0 0 88 320" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <rect x="0" y="0" width="88" height="320" rx="20" ry="20" fill="#353535" />
                                <!-- Заполненная часть прямоугольника -->
                                <rect class="chart-fill " style="--final-height: 229px; --final-y: 91px;" x="0" y="270"
                                    width="88" height="50" rx="20" ry="20" fill="#23AAEB" />
                                <!-- Текст -->
                                <text x="43" y="296" font-size="16" font-family="Arial, sans-serif" fill="white"
                                    text-anchor="middle">
                        ...
                        <div class="chartItemColumn">
                            <svg width="88" height="320" viewBox="0 0 88 320" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <rect x="0" y="0" width="88" height="320" rx="20" ry="20" fill="#353535" />
                                <!-- Заполненная часть прямоугольника -->
                                <rect class="chart-fill " style="--final-height: 256px; --final-y: 64px;" x="0" y="270"
                                    width="88" height="50" rx="20" ry="20" fill="#23AAEB" />
                                <!-- Текст -->
                                <text x="43" y="296" font-size="16" font-family="Arial, sans-serif" fill="white"
                                    text-anchor="middle">
                        ...
                        <div class="chartItemColumn">
                            <svg class="circleDiagramme" width="349" height="320" viewBox="0 0 349 349"
                                ...
                                <circle cx="190" cy="175" r="140" fill="none" class="circleDiagrammeFillWater"
                                    ...
                                    stroke-dashoffset="954" stroke-linecap="round" transform="rotate(-90 175 175)" />
                                <!-- Капля воды -->
                    ...
                    <div class="chartItem">
                        <div class="chartItemColumn">
                            <svg width="88" height="320" viewBox="0 0 88 320" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <rect x="0" y="0" width="88" height="320" rx="20" ry="20" fill="#353535" />
                                <!-- Заполненная часть прямоугольника -->
                                <rect class="chart-fill " style="--final-height: 71px; --final-y: 249px;" x="0" y="249"
                                    width="88" height="71" rx="20" ry="20" fill="#32D16D" />
                                <!-- Текст -->
                        ...
                        <div class="chartItemColumn">
                            <svg width="88" height="320" viewBox="0 0 88 320" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <rect x="0" y="0" width="88" height="320" rx="20" ry="20" fill="#353535" />
                                <!-- Заполненная часть прямоугольника -->
                                <rect class="chart-fill " style="--final-height: 320px; --final-y: 0px;" x="0" y="270"
                                    width="88" height="50" rx="20" ry="20" fill="#A832D1" />
                                <!-- Текст -->
                                <text x="43" y="296" font-size="16" font-family="Arial, sans-serif" fill="white"
                                    text-anchor="middle">
                                    0,9 л/га
                        ...
                        <div class="chartItemColumn">
                            <svg width="88" height="320" viewBox="0 0 88 320" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <rect x="0" y="0" width="88" height="320" rx="20" ry="20" fill="#353535" />
                                <!-- Заполненная часть прямоугольника -->
                                <rect class="chart-fill " style="--final-height: 285px; --final-y: 35px;" x="0" y="270"
                                    width="88" height="50" rx="20" ry="20" fill="#A832D1" />
                                <!-- Текст -->
                                <text x="43" y="296" font-size="16" font-family="Arial, sans-serif" fill="white"
                                    text-anchor="middle">
                    ...
                    <div class="chartItem">
                        <div class="chartItemColumn">
                            <svg width="88" height="320" viewBox="0 0 88 320" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <rect x="0" y="0" width="88" height="320" rx="20" ry="20" fill="#353535" />
                                <!-- Заполненная часть прямоугольника -->
                                <rect class="chart-fill " style="--final-height: 77px; --final-y: 243px;" x="0" y="243"
                                    width="88" height="77" rx="20" ry="20" fill="#32D16D" />
                                <!-- Текст -->
                                <text x="43" y="296" font-size="16" font-family="Arial, sans-serif" fill="#0E0E0E"
                                    text-anchor="middle">
                                    16 960 ₴
                        ...
                        <div class="chartItemColumn">
                            <svg width="88" height="320" viewBox="0 0 88 320" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <rect x="0" y="0" width="88" height="320" rx="20" ry="20" fill="#353535" />
                                <!-- Заполненная часть прямоугольника -->
                                <rect class="chart-fill " style="--final-height: 190px; --final-y: 130px;" x="0" y="270"
                                    width="88" height="50" rx="20" ry="20" fill="#A832D1" />
                                <!-- Текст -->
                                <text x="43" y="296" font-size="16" font-family="Arial, sans-serif" fill="white"
                                    text-anchor="middle">
        ...
        <div class="substancesListWrapper wrapper">
            ...
            <div class="substanceList">
                ...
                <div class="substanceListItem">
                    ...
                    <p>Ми протестували ефективність препаратів з різними діючими речовинами від багатьох виробників, на
    ...
    <svg width="200" height="200" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200">
        <!-- Верхняя дуга -->
        <path d="M 60 40 c 22 0 40 -18 40 -40 h -40 Z" fill="white" />
        <!-- Правая дуга -->
        <!-- Правая дуга -->
