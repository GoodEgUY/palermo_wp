                    ...
                    <div class="dashboardItem">
                        ...
                        <div class="chartItem">
                            <div class="chartItemColumn">
                                <svg width="88" height="320" viewBox="0 0 88 320" xmlns="http://www.w3.org/2000/svg">
                                    <!-- Фон прямоугольника -->
                                    <rect x="0" y="0" width="88" height="320" rx="20" ry="20" fill="#353535" />
                           ...
                           " fill="#32D16D" />
                                    <!-- Текст -->
                                    <text x="43" y="296" font-size="16" font-family="Arial, sans-serif" fill="#32D16D"
                                        text-anchor="middle">
                                        8 л/га
                                    </text>
                                </svg>
                            ...
                            <div class="chartItemColumn">
                                <svg width="88" height="320" viewBox="0 0 88 320" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <rect x="0" y="0" width="88" height="320" rx="20" ry="20" fill="#353535" />
                                    <!-- Заполненная часть прямоугольника -->
                                    <rect x="0" class="chart-fill " style="--final-height: 240px; --final-y: 80px;"
                                        y="270" width="88" height="50" rx="20" ry="20" fill="#23AAEB" />
                                    <!-- Текст -->
                                    <text x="43" y="296" font-size="16" font-family="Arial, sans-serif" fill="white"
                                        text-anchor="middle">
                                        150 л/га
                                    </text>
                                </svg>
                            ...
                            <div class="chartItemColumn">
                                <svg width="88" height="320" viewBox="0 0 88 320" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <rect x="0" y="0" width="88" height="320" rx="20" ry="20" fill="#353535" />
                                    <!-- Заполненная часть прямоугольника -->
                                    <rect x="0" class="chart-fill " style="--final-height: 288px; --final-y: 32px;"
                                        y="270" width="88" height="50" rx="20" ry="20" fill="#23AAEB" />
                                    <!-- Текст -->
                                    <text x="43" y="296" font-size="16" font-family="Arial, sans-serif" fill="white"
                                        text-anchor="middle">
                            ...
                            <div class="chartItemColumn">
                                <svg width="88" height="320" viewBox="0 0 88 320" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <rect x="0" y="0" width="88" height="320" rx="20" ry="20" fill="#353535" />
                                    <!-- Заполненная часть прямоугольника -->
                                    <rect x="0" class="chart-fill " style="--final-height: 320px; --final-y: 0;" y="270"
                                        width="88" height="50" rx="20" ry="20" fill="#23AAEB" />
                                    <!-- Текст -->
                                    <text x="43" y="296" font-size="16" font-family="Arial, sans-serif" fill="white"
                                        text-anchor="middle">
                                        200 л/га
                           ...
                           " fill="#32D16D" />
                            ...
                            <div class="chartItemColumn">
                                <svg width="88" height="320" viewBox="0 0 88 320" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <rect x="0" y="0" width="88" height="320" rx="20" ry="20" fill="#353535" />
                                    <!-- Заполненная часть прямоугольника -->
                                    <rect class="chart-fill " style="--final-height: 190px; --final-y: 130px; " x="0"
                                        y="270" width="88" height="50" rx="20" ry="20" fill="#23AAEB" />
                                    <!-- Текст -->
                                    <text x="43" y="296" font-size="16" font-family="Arial, sans-serif" fill="white"
                                        text-anchor="middle">
                            ...
                            <div class="chartItemColumn">
                                <svg width="88" height="320" viewBox="0 0 88 320" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <rect x="0" y="0" width="88" height="320" rx="20" ry="20" fill="#353535" />
                                    <!-- Заполненная часть прямоугольника -->
                                    <rect class="chart-fill " style="--final-height: 229px; --final-y: 91px;" x="0"
                                        y="270" width="88" height="50" rx="20" ry="20" fill="#23AAEB" />
                                    <!-- Текст -->
                                    <text x="43" y="296" font-size="16" font-family="Arial, sans-serif" fill="white"
                                        text-anchor="middle">
                            ...
                            <div class="chartItemColumn">
                                <svg width="88" height="320" viewBox="0 0 88 320" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <rect x="0" y="0" width="88" height="320" rx="20" ry="20" fill="#353535" />
                                    <!-- Заполненная часть прямоугольника -->
                                    <rect class="chart-fill " style="--final-height: 256px; --final-y: 64px;" x="0"
                                        y="270" width="88" height="50" rx="20" ry="20" fill="#23AAEB" />
                                    <!-- Текст -->
                                    <text x="43" y="296" font-size="16" font-family="Arial, sans-serif" fill="white"
                                        text-anchor="middle">
                        ...
                        <div class="chartItem">
                            <div class="diagrameItemColumn">
                                <svg class="circleDiagramme" width="349" height="286" viewBox="0 0 349 325"
                                    ...
                                    <circle cx="190" cy="175" r="140" fill="none" class="circleDiagrammeFillWater"
                                        stroke="#23AAEB" stroke-width="40" stroke-dasharray="917 954"
                                        stroke-dashoffset="954" stroke-linecap="round"
                                    ...
                                    <g transform="translate(220, 0)">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            ...
                                            fill="#353535" />
                                        <text id="animated-text-water" x="65" y="55" text-anchor="middle" font-size="48"
                                            font-family="Arial, sans-serif" fill="white">
                                            0
                                        </text>
                                        <text x="65" y="75" text-anchor="middle" font-size="16"
                                            font-family="Arial, sans-serif" fill="white">
                                            ЕКОНОМІЇ
                                        </text>
                                    </g>
                        ...
                        <div class="chartItem">
                            <div class="chartItemColumn">
                                <svg width="88" height="320" viewBox="0 0 88 320" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <rect x="0" y="0" width="88" height="320" rx="20" ry="20" fill="#353535" />
                                    <!-- Заполненная часть прямоугольника -->
                                    <rect class="chart-fill " style="--final-height: 71px; --final-y: 249px;" x="0"
                                        y="249" width="88" height="71" rx="20" ry="20" fill="#32D16D" />
                                    <!-- Текст -->
                                    <text x="43" y="296" font-size="16" font-family="Arial, sans-serif" fill="#0E0E0E"
                                        text-anchor="middle">
                                        0,2 л/га
                                    </text>
                                </svg>
                            ...
                            <div class="chartItemColumn">
                                <svg width="88" height="320" viewBox="0 0 88 320" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <rect x="0" y="0" width="88" height="320" rx="20" ry="20" fill="#353535" />
                                    <!-- Заполненная часть прямоугольника -->
                                    <rect class="chart-fill " style="--final-height: 320px; --final-y: 0px;" x="0"
                                        y="270" width="88" height="50" rx="20" ry="20" fill="#A832D1" />
                                    <!-- Текст -->
                                    <text x="43" y="296" font-size="16" font-family="Arial, sans-serif" fill="white"
                                        text-anchor="middle">
                                        0,9 л/га
                            ...
                            <div class="chartItemColumn">
                                <svg width="88" height="320" viewBox="0 0 88 320" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <rect x="0" y="0" width="88" height="320" rx="20" ry="20" fill="#353535" />
                                    <!-- Заполненная часть прямоугольника -->
                                    <rect class="chart-fill " style="--final-height: 285px; --final-y: 35px;" x="0"
                                        y="270" width="88" height="50" rx="20" ry="20" fill="#A832D1" />
                                    <!-- Текст -->
                                    <text x="43" y="296" font-size="16" font-family="Arial, sans-serif" fill="white"
                                        text-anchor="middle">
                        ...
                        <div class="chartItem">
                            <div class="chartItemColumn">
                                <svg width="88" height="320" viewBox="0 0 88 320" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <rect x="0" y="0" width="88" height="320" rx="20" ry="20" fill="#353535" />
                                    <!-- Заполненная часть прямоугольника -->
                                    <rect class="chart-fill " style="--final-height: 77px; --final-y: 243px;" x="0"
                                        y="243" width="88" height="77" rx="20" ry="20" fill="#32D16D" />
                                    <!-- Текст -->
                                    <text x="43" y="296" font-size="16" font-family="Arial, sans-serif" fill="#0E0E0E"
                                        text-anchor="middle">
                                        16 960 ₴
                        ...
                        <div class="chartItem">
                            <div class="diagrameItemColumn">
                                <svg class="circleDiagramme" width="349" height="286" viewBox="0 0 349 325"
                                    ...
                                    <circle cx="175" cy="160" r="140" fill="none" stroke="#353535" stroke-width="25" />
                                    <!-- Заполненная часть (95%) -->
                                    <circle cx="190" cy="175" r="140" fill="none" class="circleDiagrammeFillFuel"
                                        stroke="#A832D1" stroke-width="40" stroke-dasharray="917 954"
                                        stroke-dashoffset="954" stroke-linecap="round"
                                        transform="rotate(-90 175 175)" />
                                    ...
                                    <g transform="translate(220, 0)">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M20 0C8.95431 0 0 8.9543 0 20V80C0 91.0457 8.9543 100 20 100H68.7872C69.4371 100 70.0464 100.316 70.4212 100.847L77.3661 110.685C78.1629 111.814 79.8371 111.814 80.6339 110.685L87.5788 100.847C87.9536 100.316 88.5629 100 89.2128 100H110C121.046 100 130 91.0457 130 80V20C130 8.95431 121.046 0 110 0H20Z"
                                            fill="#353535" />
                                        <text id="animated-text-fuel" x="65" y="55" text-anchor="middle" font-size="48"
                                            font-family="Arial, sans-serif" fill="white">
                                            0
                                        </text>
                                        <text x="65" y="75" text-anchor="middle" font-size="16"
            ...
            <div class="jobStepSvgAnimationBlock">
                ...
                <svg id="mySvg" viewBox="0 0 702 223" fill="none" preserveAspectRatio="xMidYMid meet"
                    ...
                    <path d="M587 24L656 24C680.301 24 700 43.6995 700 68V68C700 92.3005 680.301 112 656 112L481 112"
                        stroke="#353535" stroke-width="4" stroke-linecap="round" id="line2to3" />
                    <path d="M225 112H46C21.6995 112 2 131.699 2 156V156C2 180.301 21.6995 200 46 200H96"
                        stroke="#353535" stroke-width="4" stroke-linecap="round" id="line3to4" />
                    <path d="M348 200H445" stroke="#353535" stroke-width="4" stroke-linecap="round" id="line4to5" />
                    <!-- Шарик. Поставим в начало первого пути (238,24) -->
                    <circle id="ball" cx="238" cy="24" r="8" fill="#32D16D" />
                    <rect id="rect5" x="461" y="176" width="220" height="47" rx="20" fill="#353535" />
                    <rect id="rect4" x="112" y="176" width="220" height="47" rx="20" fill="#353535" />
                    <rect id="rect3" x="241" y="88" width="220" height="47" rx="20" fill="#353535" />
                    <rect id="rect2" x="351" y="0" width="220" height="47" rx="20" fill="#353535" />
                    <rect id="rect1" x="2" y="0" width="220" height="47" rx="20" fill="#32D16D" />
                    <!-- Подписи для плашек -->
                    <text id="text1" x="112" y="24" text-anchor="middle" fill="white" font-size="16"
                        dy=".35em">Заявка</text>
                    <text id="text2" x="461" y="24" text-anchor="middle" fill="white" font-size="16"
                        dy=".35em">Узгодження
                        та договір
                    </text>
                    <text id="text3" x="351" y="111" text-anchor="middle" fill="white" font-size="16" dy=".35em">Огляд
                        поля
                    </text>
                    <text id="text4" x="222" y="200" text-anchor="middle" fill="white" font-size="16"
                        dy=".35em">Обприскування поля</text>
                    <text id="text5" x="571" y="200" text-anchor="middle" fill="white" font-size="16" dy=".35em">Акт
                        виконаних робіт
                    </text>
                    <path id="fullPath" d="M238 24L335 24
                  L587 24
                  ...
                  L348 200H445" fill="none" stroke="transparent" />
                </svg>
            </div>
            ...
            <div class="substanceList">
                <div class="substanceListBlock">
                    <div class="substanceListItem grey">
                        ...
                        <svg width="100" class="inseract1" height="100" viewBox="0 0 100 100" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="swiperSlideContent">
                                <div class="substanceListItem grey">
                                    ...
                                    <p>Ми протестували ефективність препаратів з різними діючими речовинами від багатьох
                                        ...
                                        на
                                        особистому досвіді.</p>
                                    <button class="transparentButton">Консультація<svg width="16" height="17"
